...
{
    public partial class JsonInvoiceCenterConfig : UserControl , ITabWorkItem
    {
        private ITransferManager _transferMgr;

        public JsonInvoiceCenterConfig()
        {
            InitializeComponent();
            _transferMgr = InvoiceClientTransferManager.GetTransferManagerForCurrentUI(this.GetType());
        }
