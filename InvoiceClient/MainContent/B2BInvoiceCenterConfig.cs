...
{
    public partial class B2BInvoiceCenterConfig : UserControl , ITabWorkItem
    {
        private ITransferManager _transferMgr;

        public B2BInvoiceCenterConfig()
        {
            InitializeComponent();
            _transferMgr = InvoiceClientTransferManager.GetTransferManagerForCurrentUI(typeof(B2BInvoiceCenterConfig));
        }
