    ...
    public class D0501Watcher : AllowanceCancellationWatcher
    {
        ...
        protected override void processError(IEnumerable<RootResponseInvoiceNo> rootInvoiceNo, XmlDocument docInv, string fileName)
        {
            if (rootInvoiceNo != null && rootInvoiceNo.Count() > 0)
            {
                ...
                Model.Schema.TurnKey.D0501.CancelAllowance invoice = docInv.ConvertTo<Model.Schema.TurnKey.D0501.CancelAllowance>();
                Model.Schema.TurnKey.D0501.CancelAllowance stored = docInv.ConvertTo<Model.Schema.TurnKey.D0501.CancelAllowance>();
