...
namespace Model.InvoiceManagement.Validator
{
    ...
    {
        //檢查基本必填項目(作廢發票)
        public static Exception CheckMandatoryFields(this Model.Schema.TurnKey.C0501.CancelInvoice invItem, GenericManager<EIVOEntityDataContext> mgr, OrganizationToken owner, out InvoiceItem invoice, out DateTime cancelDate)
        {
            invoice = null;
            cancelDate = default;
