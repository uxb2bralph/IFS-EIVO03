...
using Model.Schema.TurnKey.C0401;
using Utility;
...
namespace Model.InvoiceManagement.Validator
{
    public partial class C0401Validator : InvoiceRootInvoiceValidator
    {
        ...
        public C0401Validator(GenericManager<EIVOEntityDataContext> mgr, Organization owner) : base(mgr,owner)
        {
        ...
        protected override Exception checkInvoice()
        {
            _newItem = new InvoiceItem
            {
                ...
                CustomsClearanceMark = (byte?)_c0401Item.Main.CustomsClearanceMark,
                ...
                InvoiceAmountType = new InvoiceAmountType
                {
                    ...
                    SalesAmount =  _c0401Item.Amount.SalesAmount,
                    FreeTaxSalesAmount =  _c0401Item.Amount.FreeTaxSalesAmount,
                    ZeroTaxSalesAmount =  _c0401Item.Amount.ZeroTaxSalesAmount,
        ...
        protected override Exception checkBusiness()
        {
            ...
            if (_seller == null)
            {
                return new Exception(String.Format("賣方為非註冊營業人,開立人統一編號:{0}，TAG:< Identifier />", _c0401Item.Main.Seller.Identifier));
            }
            ...
            {
                return new Exception(String.Format("開立人已註記停用,開立人統一編號:{0}，TAG:<SellerId />", _c0401Item.Main.Seller.Identifier));
            }
        ...
        protected override Exception checkPublicCarrier()
        {
            ...
            {
                if (checkPublicCarrierId(_c0401Item.Main.CarrierId1))
                {
                    _carrier = new InvoiceCarrier
                    {
                        CarrierType = _c0401Item.Main.CarrierType,
                        CarrierNo = _c0401Item.Main.CarrierId1,
                        CarrierNo2 = _c0401Item.Main.CarrierId1
                    };
                ...
                else if (checkPublicCarrierId(_invItem.CarrierId2))
                {
                    ...
                    {
                        CarrierType = _c0401Item.Main.CarrierType,
                        CarrierNo = _c0401Item.Main.CarrierId2,
                        CarrierNo2 = _c0401Item.Main.CarrierId2
                    };

                    return null;
                }
            }
            else if (_c0401Item.Main.CarrierType == __自然人憑證)
            {
                if (_c0401Item.Main.CarrierId1 != null && Regex.IsMatch(_c0401Item.Main.CarrierId1, "^[A-Z]{2}[0-9]{14}$"))
                {
                    _carrier = new InvoiceCarrier
                    {
                        CarrierType = _c0401Item.Main.CarrierType,
                ...
                else if (_c0401Item.Main.CarrierId2 != null && Regex.IsMatch(_c0401Item.Main.CarrierId2, "^[A-Z]{2}[0-9]{14}$"))
                {
                    _carrier = new InvoiceCarrier
                    {
                        CarrierType = _c0401Item.Main.CarrierType,
            ...
            else if (_c0401Item.Main.CarrierType == __CROSS_BORDER_MURCHANT)
            {
                if (_c0401Item.Main.CarrierId1 != null)
                {
                    _carrier = new InvoiceCarrier
                    {
                        CarrierType = _c0401Item.Main.CarrierType,
        ...
        protected override Exception checkBusinessDetails()
        {
            ...
            {
                BuyerMark = _c0401Item.Main.BuyerRemarkSpecified ? (int)_c0401Item.Main.BuyerRemark : (int?)null,
        ...
        protected override Exception checkMandatoryFields()
        {
            ...
            if (_c0401Item.Main.BuyerRemark.HasValue && !Enum.IsDefined(typeof(Model.Schema.TurnKey.C0401.BuyerRemarkEnum), (int)_c0401Item.Main.BuyerRemark))
            {
            ...
            if (_c0401Item.Main.CustomsClearanceMark.HasValue && !Enum.IsDefined(typeof(Model.Schema.TurnKey.C0401.CustomsClearanceMarkEnum), _c0401Item.Main.CustomsClearanceMark))
            {
