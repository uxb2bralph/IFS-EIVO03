...
namespace Model.InvoiceManagement.zhTW
{
    public static partial class AllowanceRootValidator
    {
        ...
        public static Exception CheckAllowanceItem(this AllowanceRootAllowance item, GenericManager<EIVOEntityDataContext> mgr, out List<InvoiceAllowanceItem> productItems,out InvoiceItem originalInvoiceItem)
        {
            ...
            foreach (var i in item.AllowanceItem)
            {
                ...
                {
                    originalInvoiceItem = originalInvoice;
                }
            }
