...
namespace Model.InvoiceManagement.zhTW
{
    ...
    {
        public static string RegularExpressions = "^-?\\d{1,12}(.[0-9]*)?$";
        public static Exception CheckDataLength(this Model.Schema.TurnKey.C0401.Invoice invItem)
        {
            #region 賣方
            ...
            if (invItem.Main.BuyerRemark.HasValue && !Enum.IsDefined(typeof(Model.Schema.TurnKey.C0401.BuyerRemarkEnum), invItem.Main.BuyerRemark))
            {
            ...
            if (invItem.Main.CustomsClearanceMark.HasValue && !Enum.IsDefined(typeof(Model.Schema.TurnKey.C0401.CustomsClearanceMarkEnum), invItem.Main.CustomsClearanceMark))
            {
            ...
            if (!string.IsNullOrEmpty(invItem.Main.NPOBAN) && (invItem.Main.NPOBAN.Length < 3 || invItem.Main.NPOBAN.Length > 7))
            {
                return new Exception(String.Format("發票捐贈對象統一編號資料格式錯誤，長度為3至7碼，傳送資料：{0}，TAG:< NPOBAN />", invItem.Main.NPOBAN));
            }
        ...
        public static Exception CheckInvoice(this Model.Schema.TurnKey.C0401.Invoice invItem, GenericManager<EIVOEntityDataContext> mgr, out String trackCode, out String invNo, out DateTime invoiceDate)
        {
            trackCode = null;
            invNo = null;
        ...
        public static Exception CheckBusiness(this Model.Schema.TurnKey.C0401.Invoice invItem, GenericManager<EIVOEntityDataContext> mgr, OrganizationToken owner, out Organization seller)
        {
        ...
        public static Exception CheckAmount(this Model.Schema.TurnKey.C0401.Invoice invItem)
        {
            //應稅銷售額
        ...
        public static Exception CheckInvoiceProductItems(this Model.Schema.TurnKey.C0401.Invoice invItem, out IEnumerable<InvoiceProductItem> productItems)
        {
            short seqNo = 1;
