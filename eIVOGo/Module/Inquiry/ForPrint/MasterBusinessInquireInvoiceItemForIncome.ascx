<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MasterBusinessInquireInvoiceItemForIncome.ascx.cs" Inherits="eIVOGo.Module.Inquiry.ForPrint.MasterBusinessInquireInvoiceItemForIncome" %>
