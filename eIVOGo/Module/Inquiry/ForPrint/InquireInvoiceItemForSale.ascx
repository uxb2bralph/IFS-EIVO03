<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="InquireInvoiceItemForSale.ascx.cs" Inherits="eIVOGo.Module.Inquiry.ForPrint.InquireInvoiceItemForSale" %>
