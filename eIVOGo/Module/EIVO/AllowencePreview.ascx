 ...
 <asp:GridView ID="gvEntity" runat="server" AutoGenerateColumns="False" Width="100%" 
        ...
        >
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="單價" > <ItemTemplate><%# String.Format("{0:##,###,###,##0.##}", Eval("UnitCost"))%></ItemTemplate>  
                    <ItemStyle HorizontalAlign="Center" />
                </asp:TemplateField> 
                <asp:TemplateField HeaderText="金額(不含稅之進貨額)" > <ItemTemplate><%# String.Format("{0:##,###,###,##0.##}", Eval("invAitem.Amount"))%></ItemTemplate>  
                    <ItemStyle HorizontalAlign="Center" />
                </asp:TemplateField> 
