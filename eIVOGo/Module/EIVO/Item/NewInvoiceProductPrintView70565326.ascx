...
<asp:Repeater ID="rpList" runat="server" EnableViewState="false">
    <ItemTemplate>
        <div class="content_box">
            ...
            <p class="quantity" style="width: 50px;"><%# String.Format("{0:##,###,###,##0.##}", ((InvoiceProductItem)Container.DataItem).Piece)%></p>
            <p class="price" style="width: 80px;"><%# String.Format("{0:##,###,###,##0.##}", ((InvoiceProductItem)Container.DataItem).UnitCost) %></p>
            <p class="totalPrice" style="width: 90px;"><%# String.Format("{0:##,###,###,##0.##}", ((InvoiceProductItem)Container.DataItem).CostAmount)%></p>
        </div>
    </ItemTemplate>
</asp:Repeater>
