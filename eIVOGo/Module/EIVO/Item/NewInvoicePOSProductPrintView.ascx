        ...
        <div >
            <table style="width:4.8cm">
             ...
             <p style=" text-align:right; float:left;font-size:8pt;"><%# Item.Brief%></p>
                        ...
                        <td style="width:25%">
           <p style="text-align:right;float:left;font-size:8pt;"><%# String.Format("{0:##,###,###,##0.##}", ((InvoiceProductItem)Container.DataItem).Piece)%></p>
                            </td>
                        <td style="width:25%">
            <p style="text-align:right;float:left;font-size:8pt;"><%# String.Format("{0:##,###,###,##0.##}", ((InvoiceProductItem)Container.DataItem).UnitCost) %></p>
                            </td>
                        <td style="width:25%">
            <p style=" text-align:right; /*margin-left: 6px;*/float:right;font-size:8pt;"><%# String.Format("{0:##,###,###,##0.##}", ((InvoiceProductItem)Container.DataItem).CostAmount)%></p>
                            </td>
        </tr>
                    </table>
        </div>
