...
<table width="100%" border="0" cellspacing="0" cellpadding="4" class="tablenone">
    ...
    <tr>
        ...
        <td>
            <%# _item.CDS_Document.DocumentPrintLog.Any(l=>l.TypeID==(int)Model.Locale.Naming.DocumentTypeDefinition.E_Invoice)?"副　本":"正　本" %>
            <%--            <%# _item.CDS_Document.DocumentPrintLog.Any(l=>l.TypeID==(int)Model.Locale.Naming.DocumentTypeDefinition.E_Invoice)?"<span style=\"text-decoration:line-through;\">正　本</span>":"正　本" %>
            --%>
        </td>
        <td>
            &nbsp;
    ...
    <tr>
        ...
        <td nowrap>
            <%--<%# _item.CDS_Document.DocumentPrintLog.Any(l=>l.TypeID==(int)Model.Locale.Naming.DocumentTypeDefinition.E_Invoice)?"複印本":"<span style=\"text-decoration:line-through;\">複印本</span>" %>--%>
        </td>
        <td>
...
<table width="100%" border="0" cellpadding="2" cellspacing="0" class="table-ori">
    <tr>
        ...
        <td width="15%" align="right" class="f_black">
            <strong>
                <%# String.Format("{0:##,###,###,##0.##}",_item.InvoiceAmountType.SalesAmount) %></strong>
        </td>
    </tr>
    <tr>
        ...
        <td width="15%" align="right" class="f_black">
            <strong>
                <%# String.Format("{0:##,###,###,##0.##}",_item.InvoiceAmountType.TaxAmount) %></strong>
        </td>
    </tr>
    <tr>
        <td align="center">
        ...
        <td width="15%" align="right" class="f_black">
            <strong>
                <%# String.Format("{0:##,###,###,##0.##}",_item.InvoiceAmountType.TotalAmount) %></strong>
        </td>
    </tr>
</table>
