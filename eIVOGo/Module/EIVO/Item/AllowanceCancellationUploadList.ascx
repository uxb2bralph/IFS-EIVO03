...
<asp:GridView ID="gvEntity" runat="server" AutoGenerateColumns="False" Width="100%"
    ...
    <Columns>
        ...
        <asp:TemplateField HeaderText="未稅金額" FooterText="總計">
            <ItemTemplate>
                <%# ((GoogleInvoiceAllowance)Container.DataItem).Allowance!=null ? String.Format("{0:##,###,###,##0.##}", ((GoogleInvoiceAllowance)Container.DataItem).Allowance.TotalAmount-((GoogleInvoiceAllowance)Container.DataItem).Allowance.TaxAmount) : "" %>
            </ItemTemplate>
        ...
        <asp:TemplateField HeaderText="稅額">
            <ItemTemplate>
                <%# ((GoogleInvoiceAllowance)Container.DataItem).Allowance!=null ? String.Format("{0:##,###,###,##0.##}", ((GoogleInvoiceAllowance)Container.DataItem).Allowance.TaxAmount) : "" %>
            </ItemTemplate>
            <ItemStyle HorizontalAlign="Right" />
            <FooterStyle HorizontalAlign="Right" />
            <FooterTemplate>
        ...
        <asp:TemplateField HeaderText="含稅金額">
            <ItemTemplate>
                <%# ((GoogleInvoiceAllowance)Container.DataItem).Allowance!=null ? String.Format("{0:##,###,###,##0.##}", ((GoogleInvoiceAllowance)Container.DataItem).Allowance.TotalAmount) : "" %>
            </ItemTemplate>
            <ItemStyle HorizontalAlign="Right" />
            <FooterStyle HorizontalAlign="Right" />
            <FooterTemplate>
