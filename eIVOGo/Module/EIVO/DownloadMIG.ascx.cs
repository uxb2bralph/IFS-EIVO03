...
namespace eIVOGo.Module.EIVO
{
    public partial class DownloadMIG : EditEntityItemBase<EIVOEntityDataContext, InvoiceItem>
    {
        ...
        protected Model.Schema.TurnKey.C0401.Invoice item;
        ...
        public List<Model.Schema.TurnKey.C0401.DetailsProductItem> items;
        ...
        private void CreateInvoiceItem()
        {
            if (divC0401.Visible == true)
            {
                item = new Model.Schema.TurnKey.C0401.Invoice()
                {
                    Main = new Model.Schema.TurnKey.C0401.Main
                    {
                        InvoiceNumber = txtInvNo.Text,
                        InvoiceDate = txtInvDate.Text,
                        InvoiceTime = _invoiceDate,
                        Seller = new Model.Schema.TurnKey.C0401.MainSeller
                        {
                        ...
                        Buyer = new Model.Schema.TurnKey.C0401.MainBuyer
                        {
                        ...
                        CustomsClearanceMark = String.IsNullOrEmpty(txtCustomerMark.Text) ? CustomsClearanceMarkEnum.Item1 : (Model.Schema.TurnKey.C0401.CustomsClearanceMarkEnum)int.Parse(txtCustomerMark.Text),
                        InvoiceType = (Model.Schema.TurnKey.C0401.InvoiceTypeEnum)(int.Parse(ddInvoiceType.SelectedValue)),
                        PrintMark = ddPrintMark.SelectedValue,
                        DonateMark = (Model.Schema.TurnKey.C0401.DonateMarkEnum)int.Parse(ddDonateMark.SelectedValue),
                    ...
                    Amount = new Model.Schema.TurnKey.C0401.Amount
                    {
                        ...
                        TaxType = (Model.Schema.TurnKey.C0401.TaxTypeEnum)int.Parse(ddTaxType.SelectedValue),
                ...
                {
                    items = new List<Model.Schema.TurnKey.C0401.DetailsProductItem>();
                    String[] checkItem;
