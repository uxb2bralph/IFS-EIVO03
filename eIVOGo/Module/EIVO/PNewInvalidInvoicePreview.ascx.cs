        ...
        private void getInvoiceData(string id)
        {
            try
            {
                using (InvoiceManager im = new InvoiceManager())
                {
                    ...
                    this.lblSalesAmount.Text = String.Format("{0:##,###,###,##0.##}", detail.InvoiceAmountType.SalesAmount);
                    this.lblTaxAmount.Text = String.Format("{0:##,###,###,##0.##}", detail.InvoiceAmountType.TaxAmount);
                    this.lblTotalAmount.Text = String.Format("{0:##,###,###,##0.##}", detail.InvoiceAmountType.TotalAmount);
