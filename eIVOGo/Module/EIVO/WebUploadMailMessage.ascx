...
<script runat="server">
    ...
    protected override void OnInit(EventArgs e)
    {
        ...
        Page.ClientScript.RegisterStartupScript(this.GetType(), "deliveryDate", "$(\"input[name='deliveryDate']\").datepicker({showButtonPanel: true, changeYear: true, changeMonth: true, yearRange:'2012:+1'});", true);
