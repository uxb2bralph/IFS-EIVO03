...
<asp:GridView ID="gvEntity" runat="server" AutoGenerateColumns="False" Width="100%"
    ...
    <Columns>
        ...
        <asp:TemplateField HeaderText="未稅金額">
            <ItemTemplate><%#String.Format("{0:##,###,###,##0.##}", ((InvoiceItem)Container.DataItem).InvoiceAmountType.SalesAmount)%></ItemTemplate>
            <ItemStyle HorizontalAlign="Center" />
        </asp:TemplateField>
        <asp:TemplateField HeaderText="稅額">
            <ItemTemplate><%#String.Format("{0:##,###,###,##0.##}", ((InvoiceItem)Container.DataItem).InvoiceAmountType.TaxAmount)%></ItemTemplate>
            <ItemStyle HorizontalAlign="Center" />
        </asp:TemplateField>
        <asp:TemplateField HeaderText="含稅金額">
            <ItemTemplate><%#String.Format("{0:##,###,###,##0.##}", ((InvoiceItem)Container.DataItem).InvoiceAmountType.TotalAmount)%></ItemTemplate>
            <ItemStyle HorizontalAlign="Center" />
        </asp:TemplateField>
