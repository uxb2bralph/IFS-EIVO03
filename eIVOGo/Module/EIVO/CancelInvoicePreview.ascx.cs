...
namespace EIVO07Tools.Module.EIVO
{
    public partial class CancelInvoicePreview : System.Web.UI.UserControl
    {
        ...
        protected override void OnInit(EventArgs e)
        {
            ...
            this.dsEntity.Select += new EventHandler<DataAccessLayer.basis.LinqToSqlDataSourceEventArgs<InvoiceItem>>(dsEntity_Select);
        }

        void dsEntity_Select(object sender, DataAccessLayer.basis.LinqToSqlDataSourceEventArgs<InvoiceItem> e)
        {
            e.Query = dsEntity.CreateDataManager().EntityList.Where(i => rejectID.Contains(i.InvoiceID)).OrderByDescending(i => i.InvoiceID);
        }
