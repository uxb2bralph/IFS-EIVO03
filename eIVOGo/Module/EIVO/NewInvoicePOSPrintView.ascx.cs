...
{
    public partial class NewInvoicePOSPrintView : System.Web.UI.UserControl
    {
        ...
        {
            base.OnInit(e);
            this.PreRender += new EventHandler(InvoicePOSPrintView_PreRender);
        ...
        void rpList_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            switch (e.Item.ItemType)
            {
                ...
                case ListItemType.Item:
                    Item.NewInvoicePOSProductPrintView view = e.Item.FindControl("productView") as Item.NewInvoicePOSProductPrintView;
                    if (view != null)
        ...
        void InvoicePOSPrintView_PreRender(object sender, EventArgs e)
        {
            if (InvoiceID.HasValue)
            {
                ...
                if (_item != null)
                {
                    ...
                    this.rpList.DataSource = _item.InvoiceDetails;
