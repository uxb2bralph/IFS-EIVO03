...
{  
    ...
    public partial class EditOrganization : EditEntityItemBase<EIVOEntityDataContext, Organization>
    {
       ...
       public  XmlDocument config
        ...
        protected virtual void AddMember_PreRender(object sender, EventArgs e)
        {
            if (!this.IsPostBack)
            {
        ...
        protected void createDefaultUser(GenericManager<EIVOEntityDataContext, Organization> mgr, OrganizationCategory orgaCate)
        {
