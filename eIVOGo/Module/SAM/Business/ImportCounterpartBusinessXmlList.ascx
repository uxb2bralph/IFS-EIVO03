<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ImportCounterpartBusinessList.ascx.cs"
    Inherits="eIVOGo.Module.SAM.Business.ImportCounterpartBusinessList" %>
...
<asp:GridView ID="gvEntity" runat="server" AutoGenerateColumns="False" Width="100%"
    ...
    <Columns>
        <asp:TemplateField HeaderText="類別">
            <ItemTemplate>
                <%# ((eIVOGo.Helper.BusinessCounterpartXmlUploadManager)_mgr).BusinessType.ToString() %></ItemTemplate>
