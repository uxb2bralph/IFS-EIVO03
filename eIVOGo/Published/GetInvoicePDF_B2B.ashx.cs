                            ...
                            if (item != null)
                            {
                                ...
                                else
                                {
                                    ...
                                    using (WebClient client = new WebClient())
                                    {
                                        ...
                                        tmpFile = client.DownloadString(String.Format("{0}{1}?nameOnly=true&id={2}", Uxnet.Web.Properties.Settings.Default.HostUrl, VirtualPathUtility.ToAbsolute("~/DataView/PrintSingleInvoiceAsPDF"), item.InvoiceID));
