...
{
    public partial class NewPrintInvoicePOSPage : System.Web.UI.Page
    {
        ...
        protected virtual void initializeData()
        {
            ...
            using (InvoiceManager mgr = new InvoiceManager())
            {
                ...
                if (items != null && items.Count() > 0)
                {
                    NewInvoicePOSPrintView finalView = null;
                    foreach (var item in items)
                    {
                        ...
                        //if (String.IsNullOrEmpty(invoicePrintView))
                        //{
                            invoicePrintView = "~/Module/EIVO/NewInvoicePOSPrintView.ascx";
                        //}
                        ...
                        //theForm.Controls.Add(view);
                            finalView = (NewInvoicePOSPrintView)this.LoadControl(invoicePrintView);
