    ...
    <div class="fspace">
        ...
        <div class="customer">
            <p>
                <%= _buyer.PostCode %><br />
                <%= _buyer.Address %><br />
                <%=_model.InvoiceSeller.ReceiptNo == "27934855" ? _buyer.CustomerName + "  " + _buyer.ContactName : _buyer.ContactName%><%--<%= _buyer.ContactName %> --%>
            鈞啟
            </p>
        </div>
    </div>
    <div class="container">
        ...
        <div class="cutfield">
            ...
            <%  }
                ...
                { %>
                    <h3 style="width:4.8cm;" class="title-small"><%= _model.InvoiceSeller.CustomerName  %></h3>
            <%  }
