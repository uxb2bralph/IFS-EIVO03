    ...
    <tbody>
        <%  int idx = 0;
            ...
            foreach (var item in _items)
            {
                idx++;  %>
                    <tr>
                        <td><%= ((eIVOGo.Helper.BusinessCounterpartXmlUploadManager)_mgr).BusinessType.ToString() %></td>
                        <td><%= item.Entity.CompanyName %></td>
                        <td><%= item.Entity.ReceiptNo %></td>
                        <td><%= item.Entity.ContactEmail %></td>
                        <td><%= item.Entity.Addr %></td>
                        <td><%= item.Entity.Phone %></td>
...
<script runat="server">
    ...
    BusinessCounterpartXmlUploadManager _mgr;
    ...
    protected override void OnInit(EventArgs e)
    {
        ...
        _mgr = (BusinessCounterpartXmlUploadManager)profile["UploadManager"];
    }
