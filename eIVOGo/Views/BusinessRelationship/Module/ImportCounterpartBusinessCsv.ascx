...
<%  Html.RenderPartial("~/Views/SiteAction/FunctionTitleBar.cshtml", "匯入商務關係相對營業人資料"); %>
...
<div class="border_gray" style="overflow-x: auto; max-width: 1024px;">
    <%  var recordCount = _uploadMgr.ItemCount;
        if(recordCount>0)
        { 
             Html.RenderPartial("~/Views/BusinessRelationship/Module/ImportCounterpartBusinessCsvList.ascx"); %>
