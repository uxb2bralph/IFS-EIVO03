...
<!--交易畫面標題-->
<%  Html.RenderPartial("~/Views/SiteAction/FunctionTitleBar.cshtml", "登錄掛號郵件"); %>
<div class="border_gray">
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="left_title">
        ...
        <tr>
            ...
            <td class="tdleft">
                <input name="DeliveryStatus" value="1303" type="radio" checked="checked" />初次寄送
...
<!--表格 開始-->
<%  Html.RenderPartial("~/Views/Handling/ScriptHelper/Common.cshtml"); %>
<script runat="server">
