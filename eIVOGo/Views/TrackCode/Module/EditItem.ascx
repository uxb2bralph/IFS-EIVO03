...
<tr>
    ...
    <td><select name="InvoiceType">
            <option value="7" <%= _model.InvoiceType==(byte)Naming.InvoiceTypeDefinition.一般稅額計算之電子發票 ? "selected" : null %>><%= Naming.InvoiceTypeDefinition.一般稅額計算之電子發票 %></option>
            <option value="8" <%= _model.InvoiceType==(byte)Naming.InvoiceTypeDefinition.特種稅額計算之電子發票 ? "selected" : null %>><%= Naming.InvoiceTypeDefinition.特種稅額計算之電子發票 %></option>
        </select>
    </td>
    <td>
