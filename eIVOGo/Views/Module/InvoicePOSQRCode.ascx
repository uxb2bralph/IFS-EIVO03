...
<%  if (_qrCode!=null)
    { %>
        <img style="/*margin-left: 0.3cm;*/ margin-right: 0.3cm;" alt="" width="80" height="80" src="<%= _qrCode.CreateQRCodeImageSrc() %>" />
        <img style="/*margin-left: 0.3cm;*/ margin-right: 0.3cm;" alt="" width="80" height="80" src="<%= "**".CreateQRCodeImageSrc()  %>" />
<%  } %>
...
<script runat="server">
    ...
    protected void getQRCodeContent()
    {
        ...
        sb.Append(String.IsNullOrEmpty(_item.BuyerReceiptNo) ? "00000000" : _item.BuyerReceiptNo);
