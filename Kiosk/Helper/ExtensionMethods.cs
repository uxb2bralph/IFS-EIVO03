...
namespace Kiosk.Helper
{
    ...
    {
        public static String GetLeftQRCodeImageSrc(this InvoiceRootInvoice item, int width = 180, int height = 180, int? qrVersion = null)
        {
            bool retry = false;
            ...
            if (retry)
            {
                try
                {
                    ...
                    return qrContent.CreateQRCodeImageSrc(width: width, height: height, qrVersion: 10);
                }
                catch (Exception ex)
                {
                    Logger.Error(ex);
        ...
        public static String CreateQRCodeImageSrc(this String content, int width = 160, int height = 160, int margin = 0, int? qrVersion = null)
        {
        ...
        public static Bitmap CreateQRCode(this String content, int width = 160, int height = 160, int margin = 0, int? qrVersion = null)
        {
